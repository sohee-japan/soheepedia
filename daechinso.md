...
ソヒがMCを務めた Mnet Plus の公式ライブ配信コンテンツ  
「대.친.소（デチンソ）」に関する情報をまとめています。

---

## デチンソの魅力は？
- ソヒと他の出演者による、リラックスした雰囲気のトークが楽しめる
- ソヒ、BOYNEXTDOOR ジェヒョン、ZEROBASEONE ハンビンの3人がMCを務めた公式ライブ番組  
  回を重ねるごとに、3人の関係が深まっていく様子も見どころ
- 生放送ならではのフリートークが多く、回ごとに展開が異なる
- 公式日本語字幕付きで、初めての人でも視聴しやすい
- 公式アーカイブフル動画が無料で見られる（下の表にリンクあり）
...
という表現の略とされています。（公式動画のサムネイルにある表現です。）
